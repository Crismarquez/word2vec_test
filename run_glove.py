...
co_occurrence_mtx = glove.co_occurence.matrix_frequency(corpus, vocabulary, S_WINDOW)

learinig_rate = 0.0005
hist_cost = []
for i in range(10):
    gradient = glove.gradient.gradient_descent(vocabulary, theta, co_occurrence_mtx)
